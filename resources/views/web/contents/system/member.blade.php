                        ...
                        <div class="form-group clear-fix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="col-lg-4 col-md-6 col-sm-8 col-xs-8 info">
                                    ...
                                    <input type="text" class="form-control full-width" id="user_level1" name="title" placeholder="一级会员名称">
                                    <input type="text" class="form-control full-width" id="user_level2" name="title" placeholder="二级会员名称">
                                    <input type="text" class="form-control full-width" id="user_level3" name="title" placeholder="三级会员名称">
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 info" style="padding: 0px;">
                                    <div class="title">价格（元）</div>
                                    <input type="number" class="form-control full-width" id="user_level1_price" name="title" placeholder="">
                                    <input type="number" class="form-control full-width" id="user_level2_price" name="title" placeholder="">
                                    <input type="number" class="form-control full-width" id="user_level3_price" name="title" placeholder="">
                                </div>
                            </div>
                        </div>
